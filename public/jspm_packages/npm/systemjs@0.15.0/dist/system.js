    ...
    $__global.upgradeSystemLoader = function() {
      ...
      function r(e) {
        ...
        e.translate = function(e) {
          var r = e.source.match(a);
          if (r)
            for (var o = r[0].match(n),
                s = 0; s < o.length; s++) {
              var l = o[s].length,
                  u = o[s].substr(0, 1);
      ...
      function n(e) {
        function a(e) {
          ...
          -1 != n && "//# sourceMappingURL=" == e.source.substr(n + 1, 21) && (r = e.source.substr(n + 22, e.source.length - n - 22), "undefined" != typeof t && (r = t(e.address, r))), __eval(e.source, e.address, r), "@traceur" == e.name && (a.global.traceurSystem = a.global.System, a.global.System = g);
        }
        function r(e) {
          for (var t = [],
              a = 0,
              r = e.length; r > a; a++)
            -1 == h.call(t, e[a]) && t.push(e[a]);
          return t;
        }
        function o(t, a, r, n) {
        ...
        function i(e) {
          if (!e.register) {
            e.register = o, e.defined || (e.defined = {});
            var t = e.onScriptLoad;
            e.onScriptLoad = function(e) {
              t(e), v && (e.metadata.entry = v), b && (e.metadata.format = e.metadata.format || "register", e.metadata.registered = !0);
            };
          }
        }
        function s(e, t, a) {
          if (a[e.groupIndex] = a[e.groupIndex] || [], -1 == h.call(a[e.groupIndex], e)) {
            ...
            for (var r = 0,
              ...
              if (i && !i.evaluated) {
                ...
                if (void 0 === i.groupIndex || i.groupIndex < l) {
                  if (void 0 !== i.groupIndex && (a[i.groupIndex].splice(h.call(a[i.groupIndex], i), 1), 0 == a[i.groupIndex].length))
        ...
        function p(e, t, a) {
          ...
          if (r && !r.evaluated && r.declarative) {
            ...
            for (var n = 0,
              ...
              -1 == h.call(t, i) && (a.defined[i] ? p(i, t, a) : a.get(i));
            }
            r.evaluated || (r.evaluated = !0, r.module.execute.call(a.global));
          }
        }
        "undefined" == typeof h && (h = Array.prototype.indexOf), ("undefined" == typeof __eval || "undefined" != typeof document && !document.addEventListener) && (__eval = 0 || eval), e._extensions = e._extensions || [], e._extensions.push(n);
        var g;
        e.__exec = a;
        var v,
            b;
        ...
        e.fetch = function(e) {
          var t = this;
          return i(t), t.defined[e.name] ? (e.metadata.format = "defined", "") : (v = null, b = !1, y.call(t, e));
        };
        var w = e.translate;
        e.translate = function(e) {
          return this.register = o, this.__exec = a, e.metadata.deps = e.metadata.deps || [], Promise.resolve(w.call(this, e)).then(function(t) {
        ...
        e.instantiate = function(e) {
          ...
          if (a.defined[e.name])
            ...
            if (a.global.System = a, a.__exec(e), a.global.System = n, v && (t = v), !t && m.defined[e.name] && (t = m.defined[e.name]), !b && !e.metadata.registered)
      ...
      function o(e) {
        function t(t) {
          a = t, r = "@" + a, n = r + ("babel" == a ? "-helpers" : "-runtime"), i = "babel" == a ? a + "Helpers" : "$" + a + "Runtime";
          var o;
          o = $__curScript && $__curScript.src ? $__curScript.src.substr(0, $__curScript.src.lastIndexOf("/") + 1) : e.baseURL + (e.baseURL.lastIndexOf("/") == e.baseURL.length - 1 ? "" : "/"), e.paths[r] || (e.paths[r] = $__curScript && $__curScript.getAttribute("data-" + e.transpiler + "-src") || o + e.transpiler + ".js"), e.paths[n] || (e.paths[n] = $__curScript && $__curScript.getAttribute("data-" + n.substr(1) + "-src") || o + n.substr(1) + ".js");
        }
        e._extensions.push(o);
        var a,
            r,
            n,
            i,
            ...
            u = e.translate;
        e.translate = function(o) {
          var d = this;
          return u.call(e, o).then(function(e) {
            d.transpiler !== a && t(d.transpiler);
            var c = d;
            if (o.name == r || o.name == n)
              return u.call(c, o);
            if (("es6" == o.metadata.format || !o.metadata.format && e.match(l)) && (o.metadata.format = "es6", s && !c.global[a]))
              return c["import"](r).then(function() {
                return e;
              });
            if (s && !c.global[i] && -1 != e.indexOf(i)) {
            ...
            e.set("@@global-helpers", e.newModule({
              prepareGlobal: function(t, i) {
                ...
                for (var d in e.global)
                  if (-1 == h.call(r, d) && (!n || e.global.hasOwnProperty(d)))
                    try {
                      a[d] = e.global[d];
                    } catch (c) {
                      r.push(d);
              ...
              retrieveGlobal: function(i, s, l) {
                ...
                if (l)
                  ...
                  for (var p in e.global)
                    -1 == h.call(r, p) && (n && !e.global.hasOwnProperty(p) || p == e.global || a[p] == e.global[p] || (c[p] = e.global[p], u ? u !== e.global[p] && (d = !0) : u !== !1 && (u = e.global[p])));
                return o[i] = c, d ? c : u;
              }
            }));
          }
        }
        e._extensions.push(i), a(e);
        var r = e.instantiate;
        e.instantiate = function(e) {
          var t = this;
          a(t);
      ...
      function s(e) {
        ...
        e.instantiate = function(n) {
          return n.metadata.format || (a.lastIndex = 0, r.lastIndex = 0, (r.exec(n.source) || a.exec(n.source)) && (n.metadata.format = "cjs")), "cjs" == n.metadata.format && (n.metadata.deps = n.metadata.deps ? n.metadata.deps.concat(t(n.source)) : t(n.source), n.metadata.executingRequire = !0, n.metadata.execute = function(t, a, r) {
            ...
            o.pop(), o = o.join("/"), m._nodeRequire && (o = o.substr(5)), e.global._g = {
              global: e.global,
              exports: a,
              module: r,
              require: t,
              __filename: m._nodeRequire ? n.address.substr(5) : n.address,
              __dirname: o
            };
      ...
      function l(e) {
        function t(e, t) {
          e = e.replace(c, "");
          var a = e.match(m),
              r = (a[1].split(",")[t] || "require").replace(g, ""),
              n = v[r] || (v[r] = new RegExp(f + r + p, "g"));
          n.lastIndex = 0;
          for (var o,
              i = []; o = n.exec(e); )
            i.push(o[2] || o[3]);
        ...
        function n(e) {
          function a(a, n, o) {
            ...
            var s,
                l,
                u;
            if (-1 != (s = h.call(n, "require"))) {
              n.splice(s, 1);
              var d = o.toString();
              n = n.concat(t(d, s));
            }
            -1 != (l = h.call(n, "exports")) && n.splice(l, 1), -1 != (u = h.call(n, "module")) && n.splice(u, 1);
            var c = {
              deps: n,
              execute: function(t, a, d) {
                for (var c = [],
                    f = 0; f < n.length; f++)
                  c.push(t(n[f]));
                d.uri = e.baseURL + d.id, d.config = function() {}, -1 != u && c.splice(u, 0, d), -1 != l && c.splice(l, 0, a), -1 != s && c.splice(s, 0, r(d.id, t, e));
                var p = o.apply(i, c);
        ...
        function o(e) {
          ...
          var t = e.global;
          x = t.module, y = t.exports, w = t.define, t.module = void 0, t.exports = void 0, t.define && t.define === e.amdDefine || (t.define = e.amdDefine);
        }
        function s(e) {
          var t = e.global;
          t.define = w, t.module = x, t.exports = y;
        }
        var u = "undefined" != typeof module && module.exports;
        ...
        e.instantiate = function(e) {
          ...
          if ("amd" == e.metadata.format || !e.metadata.format && e.source.match(d)) {
            if (e.metadata.format = "amd", t.execute !== !1 && (o(t), t.__exec(e), s(t), !b && !_ && !u))
      ...
      function u(e) {
        ...
        e.map = e.map || {}, e._extensions.push(u);
        var o = e.normalize;
      ...
      function d(e) {
        "undefined" == typeof h && (h = Array.prototype.indexOf), e._extensions.push(d);
        var t = e.normalize;
      ...
      function c(e) {
        "undefined" == typeof h && (h = Array.prototype.indexOf), e._extensions.push(c), e.bundles = e.bundles || {};
        var t = e.fetch;
        e.fetch = function(e) {
          var a = this;
          if (a.trace)
          ...
          for (var r in a.bundles)
            if (-1 != h.call(a.bundles[r], e.name))
      ...
      function f(e) {
        ...
        "undefined" == typeof h && (h = Array.prototype.indexOf), e._extensions.push(f);
        ...
        e.normalize = function(e, t, r) {
          ...
          return Promise.resolve(d.call(this, e, t, r)).then(function(e) {
            ...
            var p = e.substr(0, t),
                ...
                h = m.length,
                g = o(e.substr(t + 1).split("/")[0]);
            c = u[e.substr(0, t)] || [], "string" == typeof c && (c = [c]);
            for (var v = c.length - 1; v >= 0; v--)
              if (n(g, a(c[v])))
                return p + "@" + c[v] + e.substr(t + h + 1);
            var b;
            return g.semver ? b = 0 != g.version.major || isNaN(g.version.minor) ? g.version.major : "0." + g.version.minor : g.fuzzy ? b = g.version.major + "." + g.version.minor : (b = m, c.push(m), c.sort(i), u[p] = 1 == c.length ? c[0] : c), p + "@" + b + e.substr(t + h + 1);
          });
        };
      }
      function p(e) {
        e.depCache = e.depCache || {}, e._extensions.push(p), loaderLocate = e.locate, e.locate = function(e) {
          var t = this;
      ...
      !function() {
        ...
        m = $__global.System = new LoaderPolyfill(e), m.baseURL = e.baseURL, m.paths = {"*": "*.js"}, m.originalSystem = e;
      }(), m.noConflict = function() {
        $__global.SystemJS = m, $__global.System = m.originalSystem;
      };
      var g = $__global.System.originalSystem;
      a(m), r(m), n(m), o(m), i(m), s(m), l(m), u(m), d(m), c(m), f(m), p(m);
    };
    var $__curScript,
        __eval;
    !function() {
